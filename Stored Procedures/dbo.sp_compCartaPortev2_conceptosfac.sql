...
CREATE proc [dbo].[sp_compCartaPortev2_conceptosfac]  @lgh_hdrnumber varchar(20)
...
--SECION HEADER (1:1)
    ...
    --cast(convert(decimal (10,2),isnull((orderheader.ord_rate),0)) as varchar(20))			                     --6 Subtotal (R) 
	...
	cast(convert(decimal (10,2),isnull(round((orderheader.ord_rate*.16),2,1) +@totaliva,0)) as varchar(20))
																		       +'|'+    
